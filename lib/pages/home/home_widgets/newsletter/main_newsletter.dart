                ...
                Expanded(
                  ...
                  child: selectedDocument != null
                      ? AnnouncementDetailPage(
                          ...
                          imageUrl: selectedDocument!['img_url'],
                          date: DateFormat('d/M/yyyy, h:mm a').format(
                              (selectedDocument!['date'] as Timestamp)
                                  .toDate()),
                        )
                      : const Center(child: Text("Select an announcement")),
                ),
            ],
          );
        },
                    ...
                    children: [
                      ClipRRect(
                        ...
                        child: SizedBox(
                          ...
                          height: 200,
                          child:
                              Image.network(doc['img_url'], fit: BoxFit.cover),
                        ),
                      ),
                      Padding(
