...
import 'package:postalhub_tracker/pages/profile/widget/profile_widget_onloading.dart';
...
class _ProfileOverviewWidgetState extends State<ProfileOverviewWidget> {
    ...
    if (_currentUser == null) {
      if (mounted) {
        setState(() {
          _name = "Guest";
          _userPoints = 0;
          _userBarcodeValue = "guest_user_no_barcode";
  ...
  Widget build(BuildContext context) {
    if (_isLoadingGreeting || _isLoadingUserData) {
      return const ProfileOverviewOnLoadingWidget();
    }
                                  ...
                                  child: ClipRRect(
                                      ...
                                      child: Material(
                                          ...
                                          child: InkWell(
                                            ...
                                            //MaterialPageRoute(
                                            //builder: (context) =>
                                            //ProfileEcard(barcodeValue: _userBarcodeValue, userName: displayName, userPoints: _userPoints,))); // Pass data to Ecard
                                            // },
                                            child: SizedBox(
                                                width: 595,
                                                height: 70,
